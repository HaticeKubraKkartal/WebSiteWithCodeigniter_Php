        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Makale Bilgilerini Giriniz </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" method="post" action="<?=base_url()?>admin/gelenmakale/guncelle/<?=$durum[0]->Id?>" >
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Uye Adı</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" value="<?=$durum[0]->uyeId?>---<?=$bilgi[0]->uyeAdi?>" class="form-control col-md-7 col-xs-12" type="text" name="uyeAdi">
                        </div>
                      </div>	
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<img src="<?=base_url()?>uploads/<?=$bilgi[0]->resim?>" height="100" >
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?=base_url()?>admin/gelen_makale" class="btn btn-primary" >Vazgeç</a>
